 ...
 *<ul>
 * <li>{@link tools.jackson.jakarta.rs.smile.JacksonSmileProvider} is the basic
 *    provider configured to use Jackson annotations
 *  </li>
 * <li>{@link tools.jackson.jakarta.rs.smile.JacksonXmlBindSmileProvider} is extension
