 ...
 * <li>By defining Jakarta-RS <code>Provider</code> that returns {@link YAMLMapper}s.
 ...
 * <p>
 * Note that there is also a sub-class -- ({@link JacksonXmlBindYAMLProvider}) -- that
 * is configured by default to use both Jackson and XmlBind annotations for configuration
