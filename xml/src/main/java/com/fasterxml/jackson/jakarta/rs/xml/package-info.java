 ...
 *<ul>
 * <li>{@link com.fasterxml.jackson.jakarta.rs.xml.JacksonXMLProvider} is the basic
 *    provider configured to use Jackson annotations
 *  </li>
 * <li>{@link com.fasterxml.jackson.jakarta.rs.xml.JacksonXmlBindXMLProvider} is extension
